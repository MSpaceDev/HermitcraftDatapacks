...
execute positioned ~ ~300 ~ run kill @e[type=minecraft:hopper_minecart,tag=pg_hopper,limit=9,sort=nearest]
...
execute positioned ~ ~-2 ~ run kill @e[type=minecraft:armor_stand,tag=pg_graveModel,limit=2,sort=nearest]
