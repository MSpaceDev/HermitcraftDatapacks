...
execute positioned ~ ~300 ~ run execute as @e[type=minecraft:area_effect_cloud,tag=pg_graveItems,limit=1,sort=nearest] at @s run execute as @e[type=minecraft:item,nbt={Age:0s}] run data merge entity @s {Motion:[0.0d,0.0d,0.0d]}
execute positioned ~ ~300 ~ run execute as @e[type=minecraft:area_effect_cloud,tag=pg_graveItems,limit=1,sort=nearest] at @s run tp @e[type=minecraft:item,nbt={Age:0s}] ~ ~-300 ~
