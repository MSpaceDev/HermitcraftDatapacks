...
tellraw @s ["",{"text":"Nether: ","color":"yellow"},{"text":"   ( X:","color":"yellow"},{"score":{"name":"@s","objective":"nc_x"},"color":"yellow"},{"text":" | Y:","color":"yellow"},{"score":{"name":"@s","objective":"nc_y"},"color":"yellow"},{"text":" | Z:","color":"yellow"},{"score":{"name":"@s","objective":"nc_z"},"color":"yellow"},{"text":" )","color":"yellow"}]
