...
execute as @e[type=rabbit,tag=!toast,nbt={CustomName:"{\"text\":\"Toast\"}"}] at @s run data merge entity @s {Tags:["toast"],DeathLootTable:"mobs:mobs/rabbit/toast"}
execute as @e[type=creeper,tag=!creeper,nbt={powered:1b}] at @s run data merge entity @s {Tags:["creeper"],DeathLootTable:"mobs:mobs/chargedcreeper"}
execute as @e[type=sheep,tag=!jeb,nbt={CustomName:"{\"text\":\"jeb_\"}"}] at @s run data merge entity @s {Tags:["jeb"],DeathLootTable:"mobs:mobs/jebsheep"}
