...
execute as @s[tag=!pg_illegalPosUp] align xz positioned ~0.5 ~1 ~0.5 if entity @e[tag=pg_grave,sort=nearest,limit=1,distance=..0.5] run tag @s add pg_illegalPosUp
...
execute align xz positioned ~0.5 ~ ~0.5 if entity @s[tag=pg_illegalPosUp] run function player_graves:find_pos
execute align xz positioned ~0.5 ~ ~0.5 if entity @s[tag=!pg_illegalPos,tag=!pg_illegalPosUp] run function player_graves:main
