...
summon snowball ~ ~ ~ {Tags:["hs_snowball","hs_setup","hs_portalCooldown"],Passengers:[{id:"minecraft:armor_stand",Marker:1b,Invisible:1b,NoGravity:1b,Tags:["hs_trackSnowball"],Radius:0,Duration:1000000,Particle:"block air"}]}
...
scoreboard players operation @e[tag=hs_trackSnowball,sort=nearest,limit=1] hs_id = @p hs_id
